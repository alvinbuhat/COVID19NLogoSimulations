...
;  ]
  ...
  [
    ...
    set-default-shape city2human "person"
  create-city2human initial-human-population * 0.5  ; equal distribution of population to each cities
  [
    set color white
    set size 2  ; easier to see
...
to go
  ...
  if count turtles with [color = red or color = yellow] = 0 [; user-message (word "No more infections. A total of " nb-infected " has been infected" )
    stop ]
  if count turtles with [color = white] = 0 [ ;user-message "All have been infected"
    stop ]
   ask turtles [
    move
    bounce
...
to move  ; turtle procedure
  ...
  lt random 50
  ifelse lockdown?
  [ ifelse (random-float 100 < goout-rate) ;chance of moving during lockdown
  [fd 1]
  [fd 0]
  ]
  [fd 1]
...
360
653
Chance of going out during lockdown (%)
11
0.0
1
...
"" ""
PENS
"City 2 infecteds" 1.0 0 -14439633 true "" "plot count turtles with [pcolor = green and (color = red or color = 12)]"
"City 1 infecteds" 1.0 0 -14070903 true "" "plot count turtles with [pcolor = blue and (color = red or color = 12)]"
...
<experiments>
  ...
  <experiment name="experiment" repetitions="1" runMetricsEveryStep="true">
    ...
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="infectious-days">
      <value value="14"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="Travelrate">
      <value value="50"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="init-exp">
      <value value="10"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="Protection">
      <value value="10"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="init-inf">
      <value value="10"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="death-rate">
      <value value="0.06283"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="goout-rate">
      <value value="10"/>
    </enumeratedValueSet>
  </experiment>
  <experiment name="experiment" repetitions="1" runMetricsEveryStep="true">
    ...
    <steppedValueSet variable="Travelrate" first="0" step="10" last="100"/>
    <steppedValueSet variable="init-exp" first="0" step="10" last="100"/>
    <steppedValueSet variable="Protection" first="0" step="10" last="100"/>
    <steppedValueSet variable="init-inf" first="0" step="10" last="100"/>
    <enumeratedValueSet variable="death-rate">
      <value value="0.06283"/>
    </enumeratedValueSet>
    <steppedValueSet variable="goout-rate" first="0" step="10" last="100"/>
  </experiment>
</experiments>
@#$#@#$#@
@#$#@#$#@
